        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsPaidTicket = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Travelers_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Code", "Email", "FirstName", "IsConfirmed", "LastName", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, null, "admin@travel.com", "Admin", true, "System", "admin123", "Administrator", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Travelers_ReservationId",
                table: "Travelers",
                column: "ReservationId");
